...
import { IoMdCloseCircle, IoMdMenu, IoMdVolumeHigh, IoMdVolumeOff } from "react-icons/io";
  ...
  return (
    ...
    >
              ...
              {routesMenu.map((route) => (
                ...
                >
                  ...
                  <motion.button
                    ...
                    onMouseEnter={onMouseEnter}
                    className={`flex items-center w-full lg:justify-center ${isMenuOpen ? "hover:visible" : ""
                      }`}
                  >
      ...
      <button
        onClick={toggleMute}
        onMouseEnter={onMouseEnter}
        className="fixed bottom-6 right-6 lg:static lg:bottom-auto lg:right-auto lg:mt-9 lg:-mr-72 z-50 text-3xl text-yellow-500 bg-black bg-opacity-40 p-2 rounded-full border border-gray-600 backdrop-blur-sm transition-all hover:scale-110 shadow-lg shadow-yellow-900/20"
